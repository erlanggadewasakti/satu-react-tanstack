...
export default function UniversalHomePage() {
  ...
  return (
    <Stack spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Stack spacing={2}>
              <Typography variant="h2" sx={{ fontWeight: 700, color: 'error.main' }}>
                Selamat Datang di Sistem Informasi LENS
              </Typography>

              <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.7, textAlign: 'justify' }}>
                <strong>Learning Outcome Based Information System (LENS)</strong> adalah metodologi pendidikan yang mengutamakan
                pencapaian hasil pembelajaran yang terukur dan bermakna. Platform ini menyediakan tools komprehensif untuk manajemen
                kurikulum, penilaian CLO (Course Learning Outcomes), dan evaluasi pencapaian PLO (Program Learning Outcomes).
              </Typography>

              <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.7, textAlign: 'justify' }}>
                Sistem LENS memungkinkan dosen dan koordinator program studi untuk melakukan pemetaan kurikulum, monitoring pencapaian
                target pembelajaran, dan analisis continuous improvement. Semua stakeholder dapat memantau progress akademik secara
                real-time melalui dashboard yang terintegrasi dengan standar akreditasi nasional dan internasional.
              </Typography>
            </Stack>
          </Grid>
        </Grid>
      ...
      <MainCard title="Sub-Aplikasi Tersedia (Akses Cepat)">
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          Klik modul di bawah ini untuk langsung menuju sub-aplikasi yang sesuai dengan peranan (role) Anda.
        </Typography>
        ...
        <Stack spacing={2}>
          <Stack direction="row" spacing={1.5} sx={{ alignItems: 'center' }}>
            ...
            <Typography variant="body1" sx={{ fontWeight: 500 }}>
              Service Desk Direktorat Pusat Teknologi Informasi (PUTI):{' '}
              <Typography
                component="a"
          ...
          <Stack direction="row" spacing={1.5} sx={{ alignItems: 'center' }}>
            ...
            >
              Link User Manual <ExportSquare size={16} />
            </Typography>
          </Stack>
        </Stack>
      </MainCard>
