...
const StyledStackOverlay = styled(Stack)(({ theme }) => ({
  height: '400px',
  '& .ant-empty-img-1': { fill: theme.palette.secondary[400] || theme.palette.secondary.light },
  '& .ant-empty-img-2': { fill: theme.palette.secondary.light },
  '& .ant-empty-img-3': { fill: theme.palette.secondary[200] || theme.palette.secondary.light },
